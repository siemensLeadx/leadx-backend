...
namespace Helpers.Resources
{
    public static class ResourceKeys
    {
        ...
        public const string InvalidEmailDomain = "INVALID_EMAIL_DOMAIN";
        public const string NotAllowedUser = "NOT_ALLOWED_USER";
        public const string LeadName = "LEAD_NAME";
        public const string HospitalName = "HOSPITAL_NAME";
        public const string Region = "REGION";
        public const string BusinessOpportunityType = "BUSINESS_OPPORTUNITY_TYPE";
        public const string CustomerStatus = "CUSTOMER_STATUS";
        public const string CustomerDueDate = "CUSTOMER_DUE_DATE";
        public const string Comment = "COMMENT";
        public const string ContactPerson = "CONTACT_PERSON";
        public const string LoginProviderId = "LOGIN_PROVIDER_ID";
        public const string DuplicateProviderId = "DUPLICATE_PROVIDER_ID";
        public const string Devices = "DEVICES";
        public const string SavedSuccessfully = "SAVED_SUCCESSFULLY";
        public const string DeletedSuccessfully = "DELETED_SUCCESSFULLY";
        public const string InvalidDeviceType = "INVALID_DEVICE_TYPE";
